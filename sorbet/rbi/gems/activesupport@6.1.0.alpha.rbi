...
class ActiveSupport::Cache::Store
  ...
  def delete_matched(matcher, options = _); end
  def delete_multi(names, options = _); end
...
class ActiveSupport::HashWithIndifferentAccess < ::Hash
  ...
  def convert_value(value, for: _); end
...
module ActiveSupport::Messages::Rotator
  def initialize(*_, on_rotation: _, **options); end
...
module ActiveSupport::Notifications
  ...
  def self.monotonic_subscribe(pattern = _, callback = _, &block); end
  def self.notifier; end
  def self.notifier=(_); end
  def self.publish(name, *args); end
  def self.subscribe(pattern = _, callback = _, &block); end
  def self.subscribed(callback, pattern = _, monotonic: _, &block); end
...
class ActiveSupport::Notifications::Fanout
  ...
  def start(name, id, payload); end
  def subscribe(pattern = _, callable = _, monotonic: _, &block); end
  def synchronize(&block); end
  def try_lock; end
  def unlock; end
...
class ActiveSupport::SecureCompareRotator
  ...
  def secure_compare!(other_value, on_rotation: _); end
...
class Module
  ...
  def delegate_missing_to(target, allow_nil: _); end
  ...
  def thread_cattr_accessor(*syms, instance_reader: _, instance_writer: _, instance_accessor: _, default: _); end
  def thread_cattr_reader(*syms, instance_reader: _, instance_accessor: _, default: _); end
  def thread_cattr_writer(*syms, instance_writer: _, instance_accessor: _, default: _); end
  def thread_mattr_accessor(*syms, instance_reader: _, instance_writer: _, instance_accessor: _, default: _); end
  def thread_mattr_reader(*syms, instance_reader: _, instance_accessor: _, default: _); end
  def thread_mattr_writer(*syms, instance_writer: _, instance_accessor: _, default: _); end
...
class NilClass
  ...
  def blank?; end
  def to_param; end
  def try(_method_name = _, *_, **_); end
  def try!(_method_name = _, *_, **_); end
end
