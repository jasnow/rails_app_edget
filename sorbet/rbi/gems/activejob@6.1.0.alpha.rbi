...
module ActiveJob::TestHelper
  ...
  def perform_enqueued_jobs(only: _, except: _, queue: _, at: _); end
  ...
  def enqueued_jobs_with(only: _, except: _, queue: _, at: _, &block); end
  def filter_as_proc(filter); end
  def flush_enqueued_jobs(only: _, except: _, queue: _, at: _); end
  def instantiate_job(payload); end
  def jobs_with(jobs, only: _, except: _, queue: _, at: _); end
