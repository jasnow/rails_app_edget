...
class ActiveModel::Error
  def initialize(base, attribute, type = _, **options); end
  ...
  def i18n_customize_full_message?; end
  def match?(attribute, type = _, **options); end
  def message; end
  def options; end
  def raw_type; end
...
class ActiveModel::Errors
  ...
  def [](attribute); end
  def add(attribute, type = _, **options); end
  def added?(attribute, type = _, options = _); end
  ...
  def delete(attribute, type = _, **options); end
  def details; end
  def each(&block); end
  ...
  def import(error, override_options = _); end
  ...
  def values; end
  def where(attribute, type = _, **options); end
...
class ActiveModel::NestedError < ::ActiveModel::Error
  ...
  def initialize(base, inner_error, override_options = _); end
