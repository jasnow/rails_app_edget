...
module AbstractController::Helpers::ClassMethods
  ...
  def define_helpers_module(klass, helpers = _); end
end
...
class ActionDispatch::Journey::Route
  def initialize(name:, path:, app: _, constraints: _, required_defaults: _, defaults: _, request_method_match: _, precedence: _, scope_options: _, internal: _); end
